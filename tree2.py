...
class Abilene2(Topo):
    def __init__(self, **opts):
        ...
        self.s5 = self.addSwitch('s5',dpid='0000000000000005', protocols='OpenFlow13')
        self.s6 = self.addSwitch('s6',dpid='0000000000000006', protocols='OpenFlow13')

        linkopts_1 = {'bw':100, 'delay':'1ms','max_queue_size':1000,'use_htb':'True'}
        # linkopts_2 = {'bw':200, 'delay':'1ms'}

        self.addLink(self.h1, self.s4, **linkopts_1)
        self.addLink(self.h2, self.s4, **linkopts_1)
        self.addLink(self.h3, self.s5, **linkopts_1)
        self.addLink(self.h4, self.s5, **linkopts_1)
        self.addLink(self.h5, self.s6, **linkopts_1)
